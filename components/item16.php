            ...
            <div class="div">
                <div class="item-con grid" id="16">
                    ...
                    <div class="right-con">
                        ...
                        This mechanical keyboard kit can be assembled in just minutes yet shines for years to come. Inspired by Carina constellation that signifies the hull of a ship in Latin, this keyboard is like one vessel with a formidable foundation.
                        <div class="price-div"><span class="price">PHP1,500.00</span>(46% off)</div>
                        <div class="sub-descript">
                            <li>LED Lighting</li>
                            <li>Cool-frosty acrylic keyboard</li>
                        </div>  
